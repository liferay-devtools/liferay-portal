...
[GradleDependenciesCheck](check/gradle_dependencies_check.markdown#gradledependenciescheck) | .gradle or .properties | Checks that modules are not depending on other modules. |
