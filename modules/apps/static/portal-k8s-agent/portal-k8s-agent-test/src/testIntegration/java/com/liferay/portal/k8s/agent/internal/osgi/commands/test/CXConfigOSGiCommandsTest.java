...
public class CXConfigOSGiCommandsTest {
	...
	@Test
	public void testListValidFilter() {
		String filter = "deploymentType=bundle";
	}
	...
	public void testGetConfigurations() throws Exception {
		...
		if (!failures.isEmpty()) {
			Assert.fail("Failures: " + String.join("", failures));
		}
	}
	...
	public void testGetConfigurationDataValidPid() {
		String pid = "com.liferay.client.extension.type.configuration.CETConfiguration~liferay-sample-cx-1/liferay.com";
	...
	public void testShow() throws Exception {
		Object[][] testCases = {
			{
				new String[] {
					"com.liferay.client.extension.type.configuration.CETConfiguration~liferay-sample-cx-1/liferay.com"
				},
				"projectName: liferay-sample-cx-1"
			},
	...
	private String _assertListDataOutput(Object[] testCase) throws Exception {
		...
		if (!Objects.equals(expectedOutput, namesFound)) {
			result = StringBundler.concat("FAILURE: ",Arrays.toString(filter),"\nexpected output: ",expectedOutput,"\nactual output: ",namesFound,"\n");
		}
	...
	private Configuration _getConfiguration(String pid) {
		return ReflectionTestUtil.invoke(
			_osgiCommands, "_getConfiguration",
	...
	private void _show(String[] params) throws Exception {
		Class<?> clazz = _osgiCommands.getClass();

		Method method = clazz.getMethod("show", String[].class);

		method.invoke(_osgiCommands, (Object)params);
	}
